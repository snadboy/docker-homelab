...
# Pair: Agregarr sonarrtag config 953887 "Upcoming Episodes" (tag 'airing-soon',
...
COLLECTION_NAME = "Upcoming Episodes"
PLEX_TV_SECTION = 2
...
def main(
    ...
    """Maintain the 'Upcoming Episodes' shelf: monitored shows whose next episode airs
    within `window_days`.
