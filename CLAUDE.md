...
- **Upcoming Episodes** (config 960058, tag `upcoming-episodes`, autoPoster): monitored + has files + NOTHING downloaded-unwatched + next episode ≤30d. Red banner posters — here the banner is the content. Windows: 30d for shelf AND chip.
